<div class="col-md-6 bg-white order-md-3 pt-3">
    <div class="container pt-3">
        <div class="container">
            ...
            <p class="text-center pt-4 font-weight-bold"><a class="text-decoration-none text-danger"  href="/private/jobs" alt="browse private jobs">Browse Private Jobs</a> </p> 
       

                    <?= \Config\Services::validation()->listErrors() ?>

                    <form action="/private/jobs/create" method="post" >
                        <?= csrf_field() ?>
        ...
        <p class="text-center pt-5 font-weight-bold"><a class="text-decoration-none"  href="/logout" alt="logout">Logout</a> </p>              
    </div>
</div>